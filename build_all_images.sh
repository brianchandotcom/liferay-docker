...
function build_bundle_images_dxp_71 {
	...
	build_bundle_image \
		7.1.10-dxp-25 \
		files.liferay.com/private/ee/portal/7.1.10-dxp-25/liferay-dxp-tomcat-7.1.10-dxp-25-slim-20210914164558560.7z \
		"" \
		dxp-25-7110,hotfix-5779-7110 \
		files.liferay.com/private/ee/fix-packs/7.1.10/hotfix/liferay-hotfix-5779-7110.zip

	build_bundle_image \
		7.1.10-dxp-26,7.1.10-sp7 \
		files.liferay.com/private/ee/portal/7.1.10.7/liferay-dxp-tomcat-7.1.10.7-sp7-slim-20211103124348738.7z \
		"" \
		dxp-26-7110,hotfix-5886-7110 \
		files.liferay.com/private/ee/fix-packs/7.1.10/hotfix/liferay-hotfix-5886-7110.zip
}
...
function build_bundle_images_dxp_72 {
	...
	build_bundle_image \
		7.2.10-dxp-15 \
		files.liferay.com/private/ee/portal/7.2.10-dxp-15/liferay-dxp-tomcat-7.2.10-dxp-15-slim-20211011153401541.7z \
		"" \
		dxp-15-7210,hotfix-5714-7210 \
		files.liferay.com/private/ee/fix-packs/7.2.10/hotfix/liferay-hotfix-5714-7210.zip

	build_bundle_image \
		7.2.10-dxp-16 \
		files.liferay.com/private/ee/portal/7.2.10-dxp-16/liferay-dxp-tomcat-7.2.10-dxp-16-slim-20211111033058210.7z \
		"" \
		dxp-16-7210,hotfix-5904-7210 \
		files.liferay.com/private/ee/fix-packs/7.2.10/hotfix/liferay-hotfix-5904-7210.zip
}
...
function build_bundle_images_dxp_73 {
	...
	build_bundle_image \
		7.3.10-dxp-3,7.3.10-sp3 \
		files.liferay.com/private/ee/portal/7.3.10.3/liferay-dxp-tomcat-7.3.10.3-sp3-20211220153201800.7z \
		"" \
		hotfix-3567-7310 \
		files.liferay.com/private/ee/fix-packs/7.3.10/hotfix/liferay-hotfix-3567-7310.zip
}
...
function build_bundle_images_dxp_74 {
	...
	build_bundle_image \
		7.4.13.nightly \
		files.liferay.com/private/ee/portal/nightly/liferay-dxp-tomcat-7.4.13.nightly.7z
}
...
function main {
	...
	local release_file_urls=(
		...
		releases.liferay.com/portal/7.4.3.11-ga11/liferay-ce-portal-tomcat-7.4.3.11-ga11-20220207124232466.7z
